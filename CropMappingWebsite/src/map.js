...
var acorn = new cropIcon({iconUrl: 'img/crop.png'});
...
let items = [
    [50, 70, "ET: 50 <br> County: Merced", acorn],
    [30, 180, "ET: 15 <br> County: Stanislaus", acorn],
    [180, 3, "ET: 45 <br> County: Tuolome", acorn],
    [-118.699213, 36.540753, "ET", acorn]
...
function makeMarkers(lat, long, msg, img){
    L.marker([lat, long], {icon: img}).addTo(map).bindPopup(msg);
}